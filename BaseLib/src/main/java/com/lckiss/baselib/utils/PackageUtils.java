package com.lckiss.baselib.utils;
...
import com.lckiss.baselib.service.InstallAccessibilityService;
    ...
    public static boolean installNormal(Context context, String filePath) {
        ...
        if(isAccessibilityEnabled(context, InstallAccessibilityService.class.getCanonicalName())){
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Uri apkUri = FileProvider.getUriForFile(context, "com.lckiss.appstore.fileprovider", file);

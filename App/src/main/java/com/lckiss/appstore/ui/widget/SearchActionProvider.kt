...
class SearchActionProvider(context: Context) : ActionProvider(context) {
    ...
    override fun onCreateActionView(): View {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.menu_search_provider, null, false)
        view.layoutParams = layoutParams

        view.setOnClickListener(SearchMenuClickListener())
    ...
    private inner class SearchMenuClickListener : View.OnClickListener {
